use ::lichen_core::plugin::Project
 as _;
#[derive(Debug,Default,Copy,Clone,PartialEq,Eq,Hash)]
pub struct Project;
impl ::lichen_core::plugin::Project
 for Project{
type Value<> = Value<>;type Operator<> = Operator<>;type DiagnosticKind<> = DiagnosticKind<>;}
mod unions{
use super::Project;
#[derive(Clone,Copy,)]
...
pub(super) core__equality_error: std::mem::ManuallyDrop<::lichen_core::runtime::diagnostic::EqualityError::<Project>>,
}
}
#[derive(Clone,Copy,)]
...
fn run(& self,value: <Project as ::lichen_core::plugin::Project
>::Value,node: ::lichen_core::runtime::NodeId<Project>,)->Option<<Project as ::lichen_core::plugin::Project
>::Value>{
match self.0{
0=>{<::lichen_core::runtime::operation::Sum::<> as ::lichen_core::plugin::principal_traits::Operator::<Project>>::run(unsafe{& ::lichen_core::runtime::operation::Sum::<>},value,node,
)
}1=>{<::lichen_core::runtime::operation::Index::<> as ::lichen_core::plugin::principal_traits::Operator::<Project>>::run(unsafe{& ::lichen_core::runtime::operation::Index::<>},value,node,
)
}2=>{<::lichen_core::runtime::operation::Find::<> as ::lichen_core::plugin::principal_traits::Operator::<Project>>::run(unsafe{& ::lichen_core::runtime::operation::Find::<>},value,node,
)
}_=>unreachable!(),}
}
}
