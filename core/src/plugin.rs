...
fn run<>(& self,solver: &mut crate::runtime::solve::Solver<P>,value: & <P as crate::plugin::Project>::Value,node: & crate::runtime::solve::LocalNodeId,)->Option<<P as crate::plugin::Project>::Value>;
}
...
type DiagnosticKind<>: crate::plugin::principal_traits::DiagnosticKind::<Self> + crate::plugin::DiagnosticKind::<Self>;
...
value: Option<P::Value>,)->crate::ExprId;
...
+>{
fn build(ast:&mut P::Ast,output:&crate::ExprId,array:&crate::ExprId,index:&crate::ExprId,);
}
pub trait find<P: crate::plugin::Project
+>{
fn build(ast:&mut P::Ast,output:&crate::ExprId,table:&crate::ExprId,name:&crate::ExprId,);
}
}
